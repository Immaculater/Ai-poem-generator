...
function generatePoem(event) {
  ...
  let context =
    "you are a powerful and knowledgeable AI, that can generate lovely poems about anything, Your mission is to generate a 4 line poem that relates to the user instructions in basic HTML and separate each line with a <br />. Make sure to follow the user instructions. Do not include a title to the poem. Sign the translated poem with 'SheCodes AI' inside a <strong> element which must begin after a <br /> and NOT at the beginning. and translate the generated poem in french, without 'SheCodes AI' sign. there should be a <br /> <br /> between the original poem and the translated version. the translated version should be in <em>";
